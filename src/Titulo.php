...
class Titulo implements PropriedadesExportaveisParaArrayInterface, PropriedadesImportaveisPorXMLInterface {
    ...
    /** @property string $codBarra Código de Barras. */
    private $codBarra;

    /** @property string $linDigitavel Linha Digitável */
    private $linDigitavel;
     ...
     * @param \HeitorFig\WSBoletoSantander\InstrucoesDeTitulo $instrucoes Instruções do que o banco Santander deve fazer com o título bancário.
     */
    ...
    /** Obtém a linha digitável
     *
     * @return string
     */
    public function getLinDigitavel() {
        return $this->linDigitavel;
    }
     ...
     * 
     * @param string $nossoNumero Número do Título no Banco.
     * @return \HeitorFig\WSBoletoSantander\Titulo
     */
    ...
    /** Determina a linha digitável
     *
     * @param string $linDigitavel
     * @return \HeitorFig\WSBoletoSantander\Titulo
     */
    public function setLinDigitavel($linDigitavel) {
        $this->linDigitavel = $linDigitavel;
        return $this;
    }

    /** Determina as instruções do que o banco Santander deve fazer com o título bancário.
     * 
     * @param \HeitorFig\WSBoletoSantander\InstrucoesDeTitulo $instrucoes
     * @return \HeitorFig\WSBoletoSantander\Titulo
     */
    ...
    public function exportarArray() {
        ...
        $array["TITULO.COD-BARRA"] = $this->getCodBarra();
        $array["TITULO.LIN-DIGITAVEL"] = $this->getLinDigitavel();
    ...
    public function carregarPorXML(\DOMDocument $xml) {
        ...
        $this->setCodBarra($leitor->getValorNo("cdBarra"));
        $this->setLinDigitavel($leitor->getValorNo("linDig"));
