...
class BoletoSantanderServico {
    ...
    /** @property \HeitorFig\WSBoletoSantander\ComunicadorCurlSOAP $comunicador Referência ao objeto a ser usado como ponte de comunicação entre o serviço e a extensão cURL do PHP. */
    private $comunicador;

    /** Cria uma nova instância de BoletoSantanderServico
     * 
     * @param \HeitorFig\WSBoletoSantander\ComunicadorCurlSOAP $comunicadorCurlSOAP Referência ao objeto a ser usado como ponte de comunicação entre o serviço e a extensão cURL do PHP.
     */
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Boleto $boleto Boleto que deverá ser validado e pré-cadastrado no Santander
     * @return \HeitorFig\WSBoletoSantander\Ticket
     */
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Convenio $convenio
     * @return \HeitorFig\WSBoletoSantander\Ticket
     */
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\PropriedadesExportaveisParaArrayInterface $objeto Objeto passível de ter suas propriedades exportadas.
     * @return \HeitorFig\WSBoletoSantander\Ticket
     */
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Ticket $ticket Tíquete de segurança de inclusão.
     * @return boolean
     */
    public function incluirTitulo(Ticket $ticket) {
        $respostaXML = $this->procederTicket($ticket, "registraTitulo");

        if ($this->tituloFoiIncluidoComSucesso($respostaXML))
        {
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Ticket $ticket Tíquete de segurança de sondagem.
     * @return \HeitorFig\WSBoletoSantander\Boleto
     */
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Ticket $ticket Tíquete a ser enviado.
     ...
     * 
     * @param \HeitorFig\WSBoletoSantander\Ticket $ticket Tíquete a ser envelopado
     ...
     * @param \HeitorFig\WSBoletoSantander\PropriedadesExportaveisParaArrayInterface $objeto Instância que terá suas propriedades anexadas ao XML como um array
     */
