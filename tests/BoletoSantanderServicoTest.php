...
use HeitorFig\WSBoletoSantander\Boleto;
use HeitorFig\WSBoletoSantander\BoletoSantanderServico;
use HeitorFig\WSBoletoSantander\Config;
use HeitorFig\WSBoletoSantander\Convenio;
use HeitorFig\WSBoletoSantander\InstrucoesDeTitulo;
use HeitorFig\WSBoletoSantander\Pagador;
use HeitorFig\WSBoletoSantander\Ticket;
use HeitorFig\WSBoletoSantander\Titulo;
...
class BoletoSantanderServicoTest extends PHPUnit_Framework_TestCase {
    ...
    public function testeParaSolicitarTicketDeInclusao() {
        ...
        $comunicador = $this->getMockBuilder("HeitorFig\WSBoletoSantander\ComunicadorCurlSOAP")->getMock();
